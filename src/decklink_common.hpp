...
inline ::godot::String string_to_godot(String p_string) {
    return p_string ? ::godot::String((const wchar_t *)p_string) : ::godot::String();
}
...
inline IDeckLinkIterator *create_iterator() {
    ...
    if (CoCreateInstance(CLSID_CDeckLinkIterator, nullptr, CLSCTX_ALL, IID_IDeckLinkIterator, (void **)&iterator) != S_OK) {
        return nullptr;
    }
    return iterator;
}
